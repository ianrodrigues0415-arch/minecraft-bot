...
function createBot() {
    const bot = mineflayer.createBot({
        host: 'servidorcraft.aternos.me', // <--- REEMPLAZA ESTO POR LA IP DE TU SERVER
        port: 17181,                // Puerto predeterminado de Minecraft
        username: 'pairulito',    // Nombre genérico del bot/NPC dentro del juego
